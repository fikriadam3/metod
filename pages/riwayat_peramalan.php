...
<div class="page-content">
	...
	<div class="table-container">
		<table id="riwayatperamalan" class="table">
			<thead>
				<tr>
					<th>No</th>
					<th>No Peramalan</th>
			...
			<?php 
				$no=1;
				$query_prm = "SELECT * FROM peramalan ORDER BY tgl_rml ASC";
			...
			?>
					<tr>
						...
						<td>
							<?php 
								echo $data_prm['jml_aksesoris'];
								if($data_prm['jml_aksesoris']==1){
									$nama_laporan = "laporan_peramalan";
								} else if($data_prm['jml_aksesoris']>1){
